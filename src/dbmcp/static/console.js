...
(function () {
  ...
  var ENV_COLORS = window.ENV_COLORS || { local: "#64748b", dev: "#2563eb", staging: "#d97706", prod: "#dc2626" };
  ...
  var app = Vue.createApp({
    ...
    methods: {
      ...
      loadWorkflows: function () {
        var self = this;
        apiGet("/admin/workflows/list").then(function (d) { self.wfs = d && d.ok ? d.workflows : []; });
      },
